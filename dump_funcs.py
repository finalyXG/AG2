def generator_resnet(image, options, reuse=False, name="generator"):
    with tf.variable_scope(name):
        ...
        b0 = Conv3D(128, (3, 3, 3), padding="valid", strides=(1, 1, 1), activation="relu", name="c3d0")(image)
        b1 = Conv3D(128, (3, 3, 3), padding="valid", strides=(1, 1, 1), activation="relu", name="c3d0")(b0)
        # b2 = Conv3D(128, (3, 3, 3), padding="valid", strides=(1, 1, 1), activation="relu", name="c3d0")(b1)
        # b3 = Conv3D(128, (3, 3, 3), padding="valid", strides=(1, 1, 1), activation="relu", name="c3d0")(b2)
        # b4 = Conv3D(128, (3, 3, 3), padding="valid", strides=(1, 1, 1), activation="relu", name="c3d0")(b3)
        b4_ = K.squeeze(b1,0)

        c0 = tf.pad(b4_, [[0, 0], [3, 3], [3, 3], [0, 0]], "REFLECT")
...
def generator_resnet_0(image, options, reuse=False, name="generator"):
